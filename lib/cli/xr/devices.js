...
module.exports.builder = function(yargs) {
  return yargs
    ...
    // Named probe-browser (not --browser) so --browser keeps a single
    // meaning across the family: a browser package string.
    .option('probe-browser', {
...
module.exports.handler = function(argv) {
  ...
  function enrich(entry) {
    if (!argv.probeBrowser || entry.state !== 'device' || entry.error) {
